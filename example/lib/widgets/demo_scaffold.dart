...
typedef DemoContentBuilder = Widget Function(BuildContext context, QuillController? controller, Function someFunction);
...
class _DemoScaffoldState extends State<DemoScaffold> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: _loading ? const Center(child: Text('Loading...')) : widget.builder(context, _controller, Dada1),
    );
  }
  ...
  Dada1() {
    if (kDebugMode) {
      print('in demo_scaffold.dart of quill');
    }
  }
}
