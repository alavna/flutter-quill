...
class QuillEditor extends StatefulWidget {
  ...
  factory QuillEditor.basic({
    required Function onCustomMenuItemSelected,
    ...
    return QuillEditor(
      onCustomMenuItemSelected: onCustomMenuItemSelected,
...
class QuillEditorState extends State<QuillEditor> implements EditorTextSelectionGestureDetectorBuilderDelegate {
  ...
  Widget build(BuildContext context) {
    ...
    if (isAppleOS(theme.platform)) {
      ...
      cursorOffset = Offset(iOSHorizontalOffset / View.of(context).devicePixelRatio, 0);
    } else {
    ...
    final child = RawEditor(
        onCustomMenuItemSelected: widget.onCustomMenuItemSelected,
        key: _editorKey,
        ...
        contextMenuBuilder: showSelectionToolbar ? RawEditor.defaultContextMenuBuilder : null,
...
class RenderEditor extends RenderEditableContainerBox with RelayoutWhenSystemFontsChangeMixin implements RenderAbstractEditor {
  ...
  double? getOffsetToRevealCursor(double viewportHeight, double scrollOffset, double offsetInViewport) {
    ...
    final caretTop = endpoint.point.dy - child.preferredLineHeight(TextPosition(offset: selection.extentOffset - child.container.documentOffset)) - kMargin + offsetInViewport + scrollBottomInset;
...
class RenderEditableContainerBox extends RenderBox with ContainerRenderObjectMixin<RenderEditableBox, EditableContainerParentData>, RenderBoxContainerDefaultsMixin<RenderEditableBox, EditableContainerParentData> {
  RenderEditableContainerBox({required container_node.Container container, required this.textDirection, required this.scrollBottomInset, required EdgeInsetsGeometry padding, List<RenderEditableBox>? children})
